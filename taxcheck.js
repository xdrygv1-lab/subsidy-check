...
function employment(c,T,ksics,reg,reliefs,taxAmt){
  const E=T.employment,item={key:"employment",title:E.title,level:"check",headline:"",estimate:"",points:[],basis:"조세특례제한법 제29조의7, 제29조의8"};
  ...
  if(c.emp_increase==="yes"){
    ...
    item.points.push("공제액의 20%는 농어촌특별세로 내야 해 실제 혜택은 그만큼 줄어듭니다");
